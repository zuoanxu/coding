...
-- 初始化示例商品（其中“机械键盘”库存仅 8，用于演示低库存）
INSERT INTO t_product(name, price, stock, description, create_time, update_time) VALUES
('iPhone 15 Pro', 8999.00, 100, '苹果旗舰手机', NOW(), NOW()),
('小米14', 3999.00, 200, '小米旗舰手机', NOW(), NOW()),
('华为 Mate 60', 6999.00, 150, '华为旗舰手机', NOW(), NOW()),
('联想拯救者笔记本', 7999.00, 50, '高性能游戏本', NOW(), NOW()),
('AirPods Pro', 1899.00, 300, '主动降噪耳机', NOW(), NOW()),
('机械键盘', 399.00, 8, '青轴机械键盘（低库存示例）', NOW(), NOW());
